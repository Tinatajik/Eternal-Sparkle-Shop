      ...
      <div className="py-16 px-4 md:px-6 2xl:px-0 flex justify-center items-center 2xl:mx-auto 2xl:container">
        <div className="flex flex-col justify-start items-start w-full space-y-9">
          <div className="flex flex-col xl:flex-row justify-center xl:justify-between space-y-6 xl:space-y-0 xl:space-x-6 w-full">
            <div className="p-8 bg-[#F4D35E] text-[#0D3B66]  flex flex-col ">
              <button className="border border-transparent bg-[#0D3B66] text-[#EE964B]  font-bold flex flex-row justify-center items-center space-x-2 py-4 rounded w-full">
                <div>
                  <svg
              ...
              <div className="flex gap-2 justify-center">
                <Link to="/paymentResaultSuccessful">
                  <button className="mt-8 border border-transparent bg-[#0D3B66] text-[#EE964B] font-bold text-lg flex justify-center items-center py-4 rounded w-[10rem]">
                    <div>
                      <p className="text-lg leading-4">Pay</p>
                    </div>
                  </button>
                </Link>
                <Link to="/paymentResaultFailed">
                  <button className="mt-8 border border-transparent bg-[#EE964B]  text-[#0D3B66] font-bold text-lg flex justify-center items-center py-4 rounded w-[10rem]">
                    <div>
                      <p className="text-lg leading-4">Cancel</p>
                    </div>
                  </button>
                </Link>
              </div>
